...
print("           Reception des mesure toutes les 10 minutes                ")
print("-" * n_tiret)
...
print("-" * n_tiret)
print("Forcage des port usb pour ARDUINO en lecture/ecriture")
commande_linux = os.system('sudo chmod -R 777 /dev/ttyACM0')
commande_linux = os.system('sudo chmod -R 777 /dev/ttyACM1')	
print("-" * n_tiret)
print(" ")
